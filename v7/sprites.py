...
# part7/9: ajout des mobiles
class Mob(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        self.groups = game.all_sprites, game.mobs
        pg.sprite.Sprite.__init__(self, self.groups)
        # part7/4: image du mur: TESTER, mais on voit que parfois le
        ...
        # part7/13: on veut que le zombie "pointe" vers le joueur: ajout d'une rotation
        self.rot = 0

    # part7/14 (suite du 13) : TESTER OK, ajouter qq Zombies sur la carte !
    def update(self):
