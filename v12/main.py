'''
Charge les maps faites avec l'outil Tiled
part12/1: il faut installer pytmx (avec la commande pip)
part12/2: on crée une nouvelle classe dans tilemap.py
'''
import pygame as pg
import sys
from os import path
...
class Game:
    ...
    def load_data(self):
        ...
        map_folder = path.join(game_folder, 'maps')     # part12/3
    ...
    def new(self):
        ...
        # part12/6: code inutile maintenant !
    ...
    def draw(self):
        ...
        # part12/4: on affiche la map tuilée
