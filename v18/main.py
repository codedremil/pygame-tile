'''
Ajout des sons et ajout d'un rayon de détection du joueur pour
changer l'algo de déplacement des Zombies
'''
import pygame as pg
import sys
from os import path
...
class Game:
    ...
    def load_data(self):
        ...
        # part18/7: chargement des sons et musiques
    ...
    def new(self):
        ...
        self.effects_sounds['level_start'].play()   # part18/9
        
            
    def run(self):
        # boucle principale du jeu
        self.playing = True
        # part18/8: joue la musique de fond en boucle (TESTER)
    ...
    def update(self):
        ...
        for hit in hits:
            if hit.type == 'health' and self.player.health < PLAYER_HEALTH:
                ...
                hit.kill()
                self.effects_sounds['health_up'].play() # part18/9 (TESTER)
