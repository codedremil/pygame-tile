'''
Ajout d'items qu'on peut récupérer sur la carte
'''
import pygame as pg
import sys
from os import path
...
class Game:
    ...
    def load_data(self):
        ...
        # part16/2: chargement des images des Items
        self.item_images = {}
    ...
    def new(self):
        ...
        # part16/5: on corrige un petit bug: quand l'objet est placé sur la map tuilée, 
        ...
        for tile_object in self.map.tmxdata.objects:
            ...
            # part16/6: prise en compte des items
    ...
    def update(self):
        ...
        # part16/7: teste le joueur touche un Item
        hits = pg.sprite.spritecollide(self.player, self.items, False)
        for hit in hits:
            if hit.type == 'health' and self.player.health < PLAYER_HEALTH:
                # le pack de santé ne sert que si on en a besoin !
                hit.kill()
                self.player.add_health(HEALTH_PACK_AMOUNT)    # part16/9: à ajouter    
