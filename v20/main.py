...
class Game:
    def __init__(self):
        # part20/12: pour améliorer le son on bufferise plus
    ...
    def load_data(self):
        ...
        # part20/4: il y a plusieurs formats pour la balle:
        ...
        # part20/3: chargement des sons des armes
        self.weapon_sounds = {}
    ...
    def update(self):
        ...
        for hit in hits:
            ...
            # part20/11: il y a plusieurs types d'armes (TESTER, puis initialiser le joueur avec le shotgun)
