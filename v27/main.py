...
from sprites import Player, Wall, Mob, Obstacle, Item, BreakableObstacle
...
class Game:
    ...
    def load_data(self):
        ...
        # part27/11: chargement des images des items breakable
        self.dest_obs_imgs = {}
        ...
        # part27/23: ajuste le volume sonore des effets
    ...
    def new(self):
        ...
        self.breakable_obstacles = pg.sprite.Group()  # part27/4
        ...
        for tile_object in self.map.tmxdata.objects:
            ...
            # part27/5 (mettre sur la carte des 1/2 fenêtres) (code mis en commentaire par part27/15)
            # elif tile_object.name.lower() == 'breakable_wall':
            #     BreakableObstacle(self, tile_object.x, tile_object.y,
            #              tile_object.width, tile_object.height)
            # part27/15: (mettre des door et window sur la map) (TESTER) (supprimer les anciens dessins !)
            elif tile_object.name.lower() in ['door_h', 'door_v', 'window_h', 'window_v']:
