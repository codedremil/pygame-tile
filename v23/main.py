'''
Ajout de la lumiere et des ombres
'''
import pygame as pg
import sys
from os import path
...
class Game:
    ...
    def new(self):
        ...
        self.paused = False
        self.night = False    # part23/2: pour activer/desactiver les effets de lumiere
