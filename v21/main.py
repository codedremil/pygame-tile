'''
Ajout d'effets spéciaux sur les dommages subis par le joueur
part21/3: sur la carte, il faut ajouter un objet "shotgun" sur le layer "obstacles" (TESTER)
'''
import pygame as pg
import sys
from os import path
...
class Game:
    ...
    def update(self):
        ...
        if hits:
            ...
            # part21/10: ajout de l'effet spécial (TESTER)
            # on peut ajuster la taille de DAMAGE_ALPHA, la valeur RED peut être blanche, etc..
            self.player.hit()
    ...
    # fonction d'affichage de texte (tirée des jeux précédents)
