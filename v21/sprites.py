...
class Player(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.weapon = 'pistol'
        self.damaged = False   # part21/5: on veut afficher une tâche rouge en cas de dommage
    ...
    def get_keys(self):
        ...
        # lancement d'un tir
        if keys[pg.K_SPACE]:
            # l'algo devient compliqué car il faut s'adapter à l'arme courante:
    ...
    def hit(self):
        self.damaged = True
        self.damage_alpha = chain(DAMAGE_ALPHA * 2)    # part21/9: on a besoin d'un itérateur pour next()
    ...
    def update(self):
        ...
        # part21/7: en cas de dommage on veut un effet en rouge
        if self.damaged:
            #dmg_image = self.image.copy()
            # il faudrait afficher par dessus une tâche rouge avec une valeur alpha croissante
            try:
...
class Bullet(pg.sprite.Sprite):
    def __init__(self, game, pos, dir):
        ...
        # part21/5: on veut que les balles (du shotgun) n'aillent pas à la même vitesse (TESTER)
