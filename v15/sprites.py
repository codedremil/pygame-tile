...
from settings import (
    ...
    FLASH_DURATION,
    PLAYER_LAYER, MOB_LAYER, WALL_LAYER, BULLET_LAYER, EFFECTS_LAYER
)
...
class Player(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        self._layer = PLAYER_LAYER  # part15/7
...
class Mob(pg.sprite.Sprite):
    ...
    # part14/3: fonction d'ajustement de la direction pour éviter les autres Mobs
    # (TESTER: les déplacements sont meilleur: on peut ajouter des Zombies sur la carte !)
    def avoid_mobs(self):
...
# part15/4: classe pour les effets de tir    
class MuzzleFlash(pg.sprite.Sprite):
    def __init__(self, game, pos):
        #self._layer = EFFECTS_LAYER    # part15/7
        self.groups = game.all_sprites
        pg.sprite.Sprite.__init__(self, self.groups)
        self.game = game
