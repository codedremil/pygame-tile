'''
Amélioration des mouvements des Zombies: 
    quand ils sont nombreux, ils se superposent car ils utilisent le même algo
    pour se déplacer (update de la classe Mob).
    Nous allons associer à chaque Mob un cercle d'évitement dans lequel
    on ne doit pas trouver plusieurs Mobs (voir dessin). Ce cercle doit
    agir comme un répulsif
'''
import pygame as pg
import sys
from os import path
