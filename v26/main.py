'''
Ajout des munitions limitées
Recarge de munitions
...
class Game:
    ...
    def update(self):
        ...
        for hit in hits:
            ...
            if hit.type == 'shotgun' and 'shotgun' not in self.player.weapons:
                ...
                self.player.ammo['shotgun'] = WEAPONS['shotgun']['ammo'] # part26/5
            ...
            if hit.type == 'rifle' and 'rifle' not in self.player.weapons:
                ...
                self.player.ammo['rifle'] = WEAPONS['rifle']['ammo'] # part26/5
            ...
            # part26/7: les bullets s'ajoutent à l'arme courante, les box à toutes les armes
            if hit.type == 'bullets':
    ...
    def draw_current_gun(self):
        ...
        self.draw_text(f'{self.player.ammo[self.player.weapon]}', self.hud_font, 20, BLACK, 180, 27, 'nw') # part26/8       
