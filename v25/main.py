'''
Ajout d'une armure pour le joueur
Revamping des armes
'''
import pygame as pg
import sys
...
from settings import (
    ...
    WEAPONS, MOB_DAMAGE, PLAYER_HEALTH, PLAYER_IMGS,
...
class Game:
    ...
    def load_data(self):
        ...
        # part25/21: charges les images du joueur avec kevlar
    ...
    def draw_text(self, text, font_name, size, color, x, y, align="center"):  # part25/9 (nw=>center)
    ...
    def draw_hud(self):
        ...
        self.draw_armour_health(0, 25, self.player.armour / PLAYER_ARMOUR)   # part25/7
    ...
    def draw_player_health(self, x, y, pct):
        ...
        BAR_LENGTH = 110   # part25/8
        BAR_HEIGHT = 25    # part25/8
        fill = pct * BAR_LENGTH
        ...
        pg.draw.rect(self.screen, BLACK, outline_rect, 2) # part25/9: WHITE => BLACK
        # part25/9: pour avoir le nom de la barre
